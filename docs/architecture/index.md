...
7. **[Backend](backend.md)** - API Go et communication avec clients legacy
8. **[Frontend](frontend.md)** - Interface web React
9. **[Nginx](nginx.md)** - Reverse proxy pour API locales
10. **[Traefik](traefik.md)** - Reverse proxy pour accès WAN
11. **[AdGuard Home](adguard.md)** - Service DNS local et filtrage
12. **[Ports](ports.md)** - Ports utilisés par les services
