...
> [!!!WARNING]
> **Attention : Évitez les Cartes SD pour le Stockage Principal**
...
> **Il est fortement conseillé d'utiliser un SSD connecté en USB** pour garantir la fiabilité et la longévité de votre serveur.
